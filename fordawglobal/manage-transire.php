  ...
  // DELETE FEES DETAILS
    if(isset($_POST['btn_deletepay'])){
      ...
      $div="<div class='alert alert-info alert-dismissible col-lg-12 col-lg-push-0 text-center'>
       ...
       Transire has been Removed Successfully
      </div>
      <script>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center text-uppercase">
                <div class="col-12">
                  <h3 class="mb-0"><button type="button" class="btn btn-warning btn-sm" id="" name="" onclick="window.location='add_transire?<?=$rand1?>'"><span class="fa fa-plus"></span> Add New Transire</button> </h3>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <?php switch(@$vID){ case 'print':; ?>
                <div id="tab1">
                  ...
                  <div class="col-md-6">
                    ...
                    <label class="form-control" style="padding-bottom:10%;"><span class="text-danger">Name of ship rotation no. & Date:</span> <b><?=$resultVal[2]." ".$resultVal[3];?></b></label>
                  ...
                  <div class="col-md-6">
                    <label class="form-control" style="padding-bottom:10%;"><span class="text-danger">Importers Name:</span> <b><?=$resultVal[9];?></b></label>
                    <label class="form-control" style="padding-bottom:10%;"><span class="text-danger">Address:</span> <b><?=$resultVal[10];?></b></label>
                    <label class="form-control" style="padding-bottom:10%;"><span class="text-danger">Description of goods:</span> <b><?=$resultVal[11];?></b></label>
                    <label class="form-control"><span class="text-danger">Weight Net (KG):</span> <b><?=$resultVal[12];?></b></label>
                    <label class="form-control"><span class="text-danger">Post Date:</span> <b><?=$resultVal[13];?></b></label>
