...
$title="Fordawglobal Logistic Software | Printing Daily Expenses";
...
if(isset($_GET['vw'])){
    $d=$_GET['vw'];
    $results=mysqli_query($link,"SELECT * FROM tbl_expen WHERE dates='$d'");
    if(mysqli_num_rows($results)>0){
        $result_t=mysqli_query($link,"SELECT SUM(amount) as total FROM tbl_expen WHERE dates='$d'");
...
<body oncontextmenu="return true">
  ...
  <div class="col-md-12 text-uppercase" id="main_page" style="background: #fff;padding:2rem;">
  	<div class="row">
      <?=@$div; ?>
  		<div class="col-md-12 text-center mb-4"><h1 style="font-size:1.5rem;"><img src="../assets/img/brand/logo.png" class="navbar-brand-img" alt="ford logo" height="50" width="70"> FORD A.W GLOBAL CONCEPT LIMITED</h1><h3 class="text-muted">DAILY EXPENSES FOR OFFICE MAINTENANCE</h3></div>
  	</div>
    <div class="col-md-12">
    <div class="col-md-12 text-right mb-3"><b>Date:</b> <?php echo date('d-m-Y');?></div>
      ...
      <table border="1" width="100%">
          <tr style="font-weight: bold;"><td>S/N</td>
          <td>Description</td>
          <td>Amount</td>
          <td>Date</td></tr>
        <?= @$option;?>
  ...
  <div class="row" id="printBar">
    <div class="col-md-12">
      <div class="text-center mt-3">
        <button type="button" id="btn_back" class="btn btn-danger" onclick="window.location='view_expenses?e=<?=$rand1?>'"><span class="fa fa-angle-double-left"></span> Back</button>
